...
Where We Are in Place and Time. Colonial Australia and the gold rush.
Self-contained HTML lessons, inquiry pages and printables for primary history.

Live site: https://educoder101.github.io/WWAPT-2026/
...
| `colonial-women.html` | **Colonial Women: Three Lives** (Year 5). Mary Reibey, Caroline Chisholm and Elizabeth Macarthur. A sixteen page deck: a condensed First Fleet recap, a timeline to order, thirty facts to sort into three lives, a profile and a "how she is remembered" page for each woman, a myth-busting card set, a page on whose Country each of them built on, and a gathering grid the students tick and then copy into their books. Deliberately has **no text inputs** and all writing happens in exercise books. The quiz and Padlet links are set in two variables at the top of the script block. |
...
- `before-the-gold.html` corrects three errors in the original source deck: the
  "Supreme Court House" pencil drawing is actually Charles Rodius's 1830 view of
  the Government House Stables, "Sydney in all its Glory" is about 1817 rather
  than 1827, and the St James Church lithograph is John Gardiner Austin, 1836.
